...
<div id="content">
    ...
    <div class="about_images">
        <div class="box">
            <img src="images/about_01.jpg" alt="about" />
            <p class="bold">Bidyut Dumra</p>
            <span>Director</span>
        </div>
        
        <div class="box">
            <img src="images/about_02.jpg" alt="about" />
            <p class="bold">Mitu Bhowmick Lange</p>
            <span>Director</span>
        </div>  
        
        <div class="box">
            <img src="images/about_03.jpg" alt="about" />
            <p class="bold">John Molloy</p>
            <span>Director</span>
        </div>  
    </div>
