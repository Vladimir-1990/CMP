...
<div id="content">
    ...
    if(empty($MID))
    {
        ...
        $sql_select_last = "SELECT MID FROM movies WHERE coming_soon = '1' ORDER BY MID DESC LIMIT 1";
    ...
    $sql_select_now_showing = "SELECT * FROM movies WHERE coming_soon = '1' AND MID = '$MID'";
